...
// console.log(today.getDate());
  ...
  buildMonths: function() {
    ...
    for ( let date in this.range) {
      // console.log('currentYear: ', dateSelect.currentYear)
      // console.log('dateSelect.range[date].getFullYear(): ', dateSelect.range[date].getFullYear())
      if (dateSelect.currentYear == dateSelect.range[date].getFullYear() ) {
        ...
        optionMonthSet.add(monthFromSet)
            console.log('monthFromSet: ', monthFromSet)
                // console.log(' dateSelect.currentMonth: ', dateSelect.currentMonth)
      }
    }

    console.log(optionMonthSet)
